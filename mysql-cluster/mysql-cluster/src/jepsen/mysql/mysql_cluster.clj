...
(defn install!
    ...
    [node version]
    (debian/install {:libaio1 "0.3.110-3"})
    (c/su
        (c/cd "/tmp"
              (deb-install! (cu/wget! (str "https://downloads.mysql.com/archives/"
                                           "get/p/14/file/mysql-cluster-gpl-"
                                           version
                                           "-debian9-x86_64.deb"))))
